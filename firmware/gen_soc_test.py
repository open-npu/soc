...
from gen_dma_e2e_golden import gen_pooling_test, gen_resize_test, gen_deconv_test, gen_concat_test, gen_add_test, gen_dwconv_test, gen_fc_test
...
def generate():
    ...
    generate_header(meta_int8, meta_int16, blob_int8_bytes, pool_addrs, resize_addrs,
                    deconv_addrs, concat_addrs, add_addrs, dwconv_addrs, fc_addrs, allops_int8_base, allops_int16_base)

    print(f'\nDone. Next: make && cd ../sim && make run')


def generate_header(meta_int8, meta_int16, blob_int8_size, pool_addrs=None, resize_addrs=None, deconv_addrs=None, concat_addrs=None, add_addrs=None, dwconv_addrs=None, fc_addrs=None, allops_int8_base=None, allops_int16_base=None):
