...
def generate():
    ...
    # Generate C header
    generate_header(meta_int8, meta_int16, blob_int8_bytes, pool_addrs, resize_addrs, deconv_addrs, concat_addrs, add_addrs)

    print(f'\nDone. Next: make && cd ../sim && make run')


def generate_header(meta_int8, meta_int16, blob_int8_size, pool_addrs=None, resize_addrs=None, deconv_addrs=None, concat_addrs=None, add_addrs=None):
